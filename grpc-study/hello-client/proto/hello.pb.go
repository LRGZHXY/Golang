...
const file_hello_proto_rawDesc = "" +
	...
	"\vhello.proto\"0\n" +
	"\fHelloRequest\x12 \n" +
	"\vrequestName\x18\x01 \x01(\tR\vrequestName\"1\n" +
	"\rHelloResponse\x12 \n" +
	"\vresponseMsg\x18\x01 \x01(\tR\vresponseMsg27\n" +
	"\bSayHello\x12+\n" +
	"\bSayHello\x12\r.HelloRequest\x1a\x0e.HelloResponse\"\x00B\vZ\t.;serviceb\x06proto3"
